...
parser.add_argument("-d", "--data", type=str, required=False, default="../geant4/output_background/", help="Path to directory with root files")
parser.add_argument("-m", "--metadata", type=str, required=False, default="../geant4/output_background/metadata.json", help="Path to metadata file")
